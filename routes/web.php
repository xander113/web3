...
Route::prefix('forum')->name('forum.')->group(function () {
    ...
    Route::get('/f/{id}', [ForumController::class, 'showForum'])->name('forum');
    Route::get('/t/{id}', [ForumController::class, 'showTopic'])->name('topic');
});
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/forum/t/{topicId}/reply', [ForumController::class, 'storeReply'])->name('forum.reply.store');
    ...
    Route::get('/catalog/upload', [CatalogController::class, 'create'])->name('catalog.create');
    ...
    Route::post('/character/colors', [CharacterController::class, 'updateColors'])->name('character.colors');
    ...
    Route::middleware('admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::post('/users/{id}/ban', [AdminController::class, 'ban'])->name('ban');
        Route::post('/users/{id}/unban', [AdminController::class, 'unban'])->name('unban');
